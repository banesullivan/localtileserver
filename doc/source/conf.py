...
L.tileLayer('https://tileserver.banesullivan.com/api/tiles/{z}/{x}/{y}.png?projection=EPSG:3857&filename=https://data.kitware.com/api/v1/file/626854a14acac99f42126a74/download', {
