...
class TestGetCleanFilenameGDALPrefixes:
    ...
    def test_gdal_prefix_passthrough(self, prefix):
    ...
    def test_http_url_not_affected(self):
    ...
    def test_invalid_path_still_raises(self):
...
@requires_gti
class TestGTIIntegration:
    """Integration tests for GTI support through the full stack."""

    def test_get_clean_filename_gti_prefix(self, gti_index):
    ...
    def test_get_clean_filename_gti_extension(self, gti_index):
    ...
    def test_tileclient_gti_prefix(self, gti_index):
    ...
    def test_tileclient_gti_extension(self, gti_index):
        from localtileserver import TileClient
    ...
    def test_tileclient_gti_thumbnail(self, gti_index):
        from localtileserver import TileClient
